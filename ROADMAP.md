...
4. strengthen deterministic selected-node explorer interaction/controller coverage now that #466/#467 activate impact plus affected-test/workflow intelligence in the local product, preserving stale-selection/race safety and independent query/presentation/test/workflow bounds;
