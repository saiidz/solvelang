...
- `DURABLE_CONFIRMATION_PROVIDER` (`disabled` until an approved provider has been configured and tested; do not set to `approved` without an implemented, independently verified provider adapter)
