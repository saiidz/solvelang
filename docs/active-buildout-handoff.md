...
1. improve query/path/impact quality and evidence explanations without weakening deterministic bounds;
2. improve MCP/Codex read-only integration over merged graph/intelligence contracts;
...
3. Continue Repository Audit query/evidence quality, MCP/Codex integration, conservative remaining relationships, visual-explorer ergonomics, and cross-platform tests.
4. Continue Solve Graph conservative language/reference adapters and query/path/impact quality.
