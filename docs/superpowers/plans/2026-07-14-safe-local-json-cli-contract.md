...
Make dry-run imply a strict safe policy and no-network force `allow_network=false`. Construct execution and canonical source-loading policies immediately after argument parsing.
