    ...
    <main className="min-h-screen bg-white text-slate-900">
      <section className="mx-auto max-w-3xl px-6 py-20">
        ...
        <div className="mt-8 space-y-6 leading-7 text-slate-600">
          ...
          <p>Before a purchased report can be recovered, a durable contract confirmation containing the product, price, terms version, consent record, delivery description, support contact, and immutable versioned Terms and Refund Policy text must be safely queued. Production checkout remains blocked until an approved provider is configured and legal identity and retention controls are verified.</p>
