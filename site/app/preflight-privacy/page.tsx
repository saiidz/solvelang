    ...
    <main className="min-h-screen bg-white text-slate-900">
      <section className="mx-auto max-w-3xl px-6 py-20">
        ...
        <div className="mt-8 space-y-6 leading-7 text-slate-600">
          ...
          <p>Checkout sends an opaque random scan ID and accepted terms version to SolveLang&apos;s entitlement API. The service stores only the scan ID, terms version, and a server-generated acceptance timestamp in Stripe PaymentIntent metadata. Workflow names, node parameters, credential metadata, report contents, Turnstile tokens, IP addresses, and user agents are not included in PaymentIntent metadata.</p>
          ...
          <p>The entitlement service stores the opaque scan ID, Stripe PaymentIntent ID, payment and refund status, event IDs, timestamps, and automatic expiration time. DynamoDB time-to-live removes expired entitlement records.</p>
