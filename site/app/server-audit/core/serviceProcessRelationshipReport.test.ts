...
const SERVICE_PROCESS_RELATIONSHIP_LIMITATION =
  "Service-process relationship findings use only conservative exact static-label matches across supplied service and process records; grouped, unmatched, skipped, or truncated mappings are completeness/integrity signals and do not prove process ownership, service runtime health, process collection completeness, or collector authority.";
...
test("canonical reports compose service-process relationship uncertainty with structural evidence", () => {
