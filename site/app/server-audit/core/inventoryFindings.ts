...
const TITLES: Record<ServerAuditInventoryIssueKind, string> = {
  ...
  "conflicting-certificate-metadata": "Certificate inventory reports conflicting expiry metadata",
...
const RECOMMENDATIONS: Record<ServerAuditInventoryIssueKind, string> = {
  ...
  "conflicting-certificate-metadata": "Re-collect certificate inventory and reconcile duplicate expiry metadata before relying on certificate-expiry posture; this read-only evidence does not verify the actively served certificate.",
