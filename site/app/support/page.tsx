...
export const metadata: Metadata = { title: "Workflow Preflight Support — SolveLang", description: "Self-service help for SolveLang Workflow Preflight scanning, checkout, reports, privacy, and refunds." };
