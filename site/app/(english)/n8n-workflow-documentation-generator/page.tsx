...
export const metadata: Metadata = { title: "n8n Workflow Documentation Generator — SolveLang", description: "Generate readable evidence and remediation guidance from an exported n8n workflow.", alternates: alternatesForRoute("n8n-workflow-documentation-generator") };
