...
export const metadata: Metadata = { title: "n8n Workflow Validator — SolveLang", description: "Validate n8n workflow structure, triggers, branches, failure handling, and review gates before deployment.", alternates: alternatesForRoute("n8n-workflow-validator") };
