...
export const metadata: Metadata = { title: "n8n Security Scanner", description: "Scan n8n workflow exports for code execution, credential references, unsafe AI paths, and missing safeguards.", alternates: alternatesForRoute("n8n-security-scanner") };
