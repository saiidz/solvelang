...
export const metadata: Metadata = { title: "n8n Workflow Tester", description: "Test exported n8n workflows for structural risks without executing them.", alternates: alternatesForRoute("n8n-workflow-tester") };
