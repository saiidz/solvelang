...
export const metadata: Metadata = { title: "n8n Error Checker — SolveLang", description: "Check n8n workflow exports for missing error paths, disabled safeguards, and risky external calls.", alternates: alternatesForRoute("n8n-error-checker") };
